...
const LogotypeCentered = ({ text = 'Text' }) => {    
    ...
    return (
        <div className="cursor-pointer w-full h-1/15 flex items-center justify-center sm:display" onClick={() => navigate('/dashboard')}>
            ...
            <div
                className="text-xl ml-3 lg:ml-5 whitespace-nowrap w-fit sm:text-xl md:text-lg lg:text-xl xl:text-2x1 font-bold h-full flex items-center justify-center text-sky-50 px-3 xl:px-5 border-l-2 border-sky-50"
...
export default LogotypeCentered;