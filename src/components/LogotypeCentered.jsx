const LogotypeCentered = ({ text = 'Text', isMobile }) => {
    ...
    return (
        <div className="w-full h-1/15 flex items-center">
            ...
            <div
                className="ml-5 whitespace-nowrap w-fit text-[1.5em] sm:text-xl md:text-2xl font-bold h-full flex items-center justify-center text-sky-50 px-5 border-l-2 border-sky-50"
